...
class Auto {
    ...
    obtenerResumen() {
        if (this.motor === "electrico") {
            return "El auto es de color " + this.color + " tiene" + this.llantas + " llantas y su matricula es " + this.matricula + " y no necesita gasolina";
        } else {
            return "tu motor utiliza gasolina y es de color " + this.color + "tiene " + this.llantas + "y su matricula es " + this.matricula;
        }
    }
}
